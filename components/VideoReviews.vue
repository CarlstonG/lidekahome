<template>
  <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div>
        <div class="rounded-lg h-full bg-gradient-to-r from-indigo-400 to-purple-500 p-4 text-white animate-pulse transition-all transform hover:scale-105 cursor-pointer" @click="openModal('2')">
          <div class="flex items-center space-x-4">
            <div>
      ...
      <div>
        <div class="rounded-lg h-full bg-gradient-to-r from-indigo-400 to-purple-500 p-4 text-white animate-pulse transition-all transform hover:scale-105 cursor-pointer" @click="openModal('3')">
          <div class="flex items-center space-x-4">
            <div>
              <img src="~assets/3.jpg" class="object-cover w-28 h-28 rounded-full" />
            </div>
            <div>
              <div class="mb-2 flex items-center">
                <svg v-for="i in 5" class="text-yellow-400 h-8 w-8 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
