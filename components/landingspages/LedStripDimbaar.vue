<template>
  <div class="bg-black">
    ...
    <div class="max-w-7xl mx-auto space-y-10 mb-10 px-6 lg:px-0">
      ...
      >
        <p class="text-white font-extralight">
          Sommige led strips - zoals de Lideka led strips - zijn standaard dimbaar. Voor het dimmen van de led strips kan bijvoorbeeld een <NuxtLink to="/products/afstandsbediening-bluetooth-led-strips" class="link">bluetooth afstandsbediening</NuxtLink> worden gebruikt. Wanneer de led strip niet standaard dimbaar is, kunnen er diverse methoden worden toegepast die het dimmen van de led strip mogelijk maken. Elke methode en/of toepassing heeft zijn eigen voor- en nadelen. Welke manier je gebruikt, is afhankelijk van de omvang van je ledstrip-project. Bij grote projecten met vele, meerdere of lange led strips is een andere methode voor het dimmen beter dan voor een project met slechts één enkele led strip. Daarnaast hangt het er ook vanaf welk dimeffect je wilt bereiken - ga je voor een lichte dimming of wil je verschillende dimstanden voor je led strips?
        </p>
      </LongParagraph>
