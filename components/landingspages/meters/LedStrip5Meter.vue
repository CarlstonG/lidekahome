  ...
  <div class="bg-black">
    ...
    <div class="mx-auto max-w-7xl mt-10 mb-10">
      <LongParagraph>
        <p class="text-white font-extralight">
          Ben jij opzoek naar een <NuxtLink to="/categorie/led-strips">strip</NuxtLink> van 5 meter die jouw favoriete kamer omtovert tot een ware lichtshow of heb je liever een oase van rust? Met de <NuxtLink to="/categorie/led-strips">strips</NuxtLink> van 5 meter bij Lideka kan het allemaal. We hebben overal aan gedacht, en we leveren alleen de meest innovatieve, kwalitatieve en gemakkelijke strip voor jou. Onze strips van 5 meter beschikken over een enorm aantal super heldere lampjes die volledig dimbaar zijn, en dus creëer je altijd de perfecte setting
        </p>
      </LongParagraph>
    </div>
    ...
    <div class="max-w-7xl mx-auto space-y-10 mb-10 px-6 lg:px-0">
      ...
      >
        ...
        <p class="text-white font-extralight">
          De <NuxtLink to="/categorie/led-strips">RGB strips</NuxtLink> 5 meter van Lideka beschikken over 16 miljoen kleuren. Het heeft 60 lampjes per meter, en deze lampjes zijn van de hoogste kwaliteit. De RGB strip zelf is gemaakt met topkwaliteit materialen en componenten om ervoor te zorgen dat u het beste product voor uw geld krijgt. Hij bezit bijzonder mooie kleuren zoals, blauw, rood en ook bijvoorbeeld de kleur groen, maar dat is niet alles, bestel vandaag, en ontdek morgen alle RGB kleuren..
        </p>
        <p class="text-white font-extrabold">
          <strong>RGBIC</strong>
        </p>
        <p class="text-white font-extralight">
          De <NuxtLink to="/categorie/rgb-ic-led-strips">RGBIC strips</NuxtLink> hebben ook 16 miljoen kleuren, en beschikken ook over 60 lampjes per meter. Toch is deze versie net iets anders, deze strip heeft een unieke eigenschap, en dat is de mogelijkheid om verschillende kleuren lampjes tegelijk door de strip heen te laten schieten.
        </p>
      </TextWithImage>

      <TextWithImage
          title="Bediening verlichting"
          imageAlt="Bediening verlichting"
          :imageSrc="require('~/assets/design/landings/led-pakketten/pakket-2.jpg')"
          reverse="true"
      >
        <p class="text-white font-extralight">
          De bediening kan maar liefst op drie manieren:
        </p>
        <ul class="text-white font-extralight">
          <li>- Bediening via afstandsbediening</li>
          <li>- Met de App</li>
          <li>- Of met de controller</li>
        </ul>
        <p class="text-white font-extralight">
          Alle drie de bedieningsmogelijkheden beschikken over een goede kwaliteit materiaal.
        </p>
      </TextWithImage>
      ...
      >
        <p class="text-white font-extralight">
          Het aantal lampjes op een gehele strip zegt enorm veel over de helderheid. Wij kunnen jou gerust stellen met het feit dat je voor 60 per meter kiest, aangezien dit echt meer dan voldoende is. Onze strip extra helder RGB, brengt het meeste licht op.
        </p>
      </TextWithImage>

      <CTA
          to="/products/rgb-led-light-strip-5-meter-smart-verlichting"
      >
        Bekijk de 5 meter LED-strip
      </CTA>
      ...
      <TextWithImage
          title="5 meter strips"
          imageAlt="5 meter strips"
          :imageSrc="require('~/assets/design/landings/led-pakketten/pakket-2.jpg')"
          reverse="true"
      >
        <p class="text-white font-extralight">
          5 meter strip is een hele gebruikelijke lengte, dit heeft te maken met het feit dat de meeste muren, kamers en huizen toch wel een lengte of breedte hebben van 5 meter. Ook brengt 5 meter LED een hoge hoeveelheid licht op, mits er genoeg lampjes per meter LED hebt. Wij raden een licht kleur RGB of RGBIC aan, hier heb je talloze mogelijkheden en combinaties.
        </p>
      </TextWithImage>
