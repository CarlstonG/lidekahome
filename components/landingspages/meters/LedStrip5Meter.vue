<template>
  <div class="bg-black">
    ...
    <div class="mx-auto max-w-7xl mt-10 mb-10">
      <LongParagraph>
        <p class="text-white font-extralight">
          Ben jij opzoek naar een <NuxtLink to="/categorie/led-strips">LED-strip</NuxtLink> van 5 meter die jouw favoriete kamer omtovert tot een ware lichtshow of heb je liever een oase van rust? Met de <NuxtLink to="/categorie/led-strips">LED-strips</NuxtLink> van 5 meter bij Lideka kan het allemaal. We hebben overal aan gedacht, en we leveren alleen de meest innovatieve, kwalitatieve en gemakkelijke LED-strips voor jou. Onze LED-strips van 5 meter beschikken over een enorm aantal super heldere Led’s die volledig dimbaar zijn, en dus creëer je altijd de perfecte setting
        </p>
      </LongParagraph>
    </div>
    ...
    <div class="max-w-7xl mx-auto space-y-10 mb-10 px-6 lg:px-0">
      ...
      >
        <p class="text-white font-extralight">
          5 meter LED is een hele gebruikelijke lengte, dit heeft te maken met het feit dat de meeste muren, kamers en huizen toch wel een lengte of breedte hebben van 5 meter. Ook brengt 5 meter LED een hoge hoeveelheid licht op, mits er genoeg lampjes per meter LED hebt. Wij raden een licht kleur RGB of RGBIC aan, hier heb je talloze mogelijkheden en combinaties.
        </p>
      </TextWithImage>
