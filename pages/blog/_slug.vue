        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
          ...
          <div class="max-w-prose prose-lg mx-auto pt-6">
            <div class="flex justify-center space-x-4">
              <a :href="`https://www.facebook.com/sharer/sharer.php?u=${url}`" target="_blank" class="text-social-fb hover:text-opacity-40">
              ...
              <a :href="`https://twitter.com/intent/tweet?turl=${url}`" target="_blank" class="text-social-twitter hover:text-opacity-40">
              ...
              <a :href="`https://api.whatsapp.com/send?text=${url}`" target="_blank" class="text-social-whatsapp hover:text-opacity-40">
              ...
              <a :href="`http://pinterest.com/pin/create/button/?url=${url}`" target="_blank" class="text-social-pinterest hover:text-opacity-40">
