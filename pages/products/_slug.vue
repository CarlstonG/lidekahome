        ...
        <div class="grid grid-cols-1 md:grid-cols-12 mx-6 lg:mx-0 relative">
          <div class="px-0 md:px-6 mb-8 md:mb-0 col-span-1 md:col-span-6">
            ...
            >
              ...
              <div v-if="product.priceCompare" class="absolute p-2 right-4 top-4 rounded text-white font-bold animated-bg z-50">
            ...
            <div class="flex mb-2 mt-2 ">
              ...
              <div>
                <div v-if="product.priceCompare" class="flex">
                  <div class="text-base ml-2 bg-yellow-400 font-bold italic pt-1 px-2">{{ savePercentage(product.priceCompare, product.price) }}</div>
...
import { formatMoney, savePercentage, getRatingStars, pricePerMeter, addCustomerImages, handleMostPopularBadge } from "../../services/Helpers";
