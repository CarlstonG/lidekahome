<template>
  ...
  <div class="grid gap-4 md:grid-cols-3">
    <div class="p-4 shadow">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="font-bold text-indigo-500 md:text-lg">Rick Hoek</div>
     ...
     <div class="p-4 shadow">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="font-bold text-indigo-500 md:text-lg">Daniela Castrillon</div>
        <p class="mb-3 text-sm text-gray-500 md:text-base md:mb-4">
          CoFounder / SMM
        </p>
     ...
     <div class="p-4 shadow">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="font-bold text-indigo-500 md:text-lg">Carlston Grefalde</div>
        <p class="mb-3 text-sm text-gray-500 md:text-base md:mb-4">
          Web Developer
        </p>
  ...
  <div class="grid gap-4 md:grid-cols-3">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="font-bold text-indigo-500 md:text-lg">Johannes Renz B. Atian</div>
        <p class="mb-3 text-sm text-gray-500 md:text-base md:mb-4">
          Lead Digital Artist
        </p>
     ...
     <div class="p-4 shadow mt-2">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="font-bold text-indigo-500 md:text-lg">Haydee Ricca Tomas</div>
        <p class="mb-3 text-sm text-gray-500 md:text-base md:mb-4">
          VA
        </p>
